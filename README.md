...
### Later Development
- And hencefort, he produce a `Living Book`, "the Book had Life to it"...or in other words...Add Personal Organization. I am guessing there would be some pre-defined structure to the default document, there would be certain root nodes, key to the programs understanding of the structure. it comes later on, but here are the notes...
```
